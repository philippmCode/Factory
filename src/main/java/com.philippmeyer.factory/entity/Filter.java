...
import jakarta.persistence.*; // Oder javax.persistence.* für ältere Spring Boot Versionen
import java.util.ArrayList; // Für das Transient-Feld
import java.util.HashSet;
import java.util.List;   // Für das Transient-Feld
